...
const App = () => {
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "0 auto", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <h1 style={{ color: "#2c3e50", marginBottom: "30px", textAlign: "center" }}>TODO App</h1>
      ...
      <ul style={{ listStyleType: "none", padding: "0" }}>
        {todos.map((todo) => (
          ...
          >
            <h3 style={{ margin: "0 0 10px 0", color: "#2c3e50" }}>{todo.title}</h3>
            <p style={{ margin: "0 0 15px 0", color: "#666" }}>{todo.description}</p>
